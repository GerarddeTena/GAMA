...
export const CARD_INFO = [
    ...
    },
    {
        ...
        description: `Create your own character by choosing the type you want to play as
          and customizing it to your liking.`
    },
    {
        title: 'Character Types',
        description: `You can choose between Human, Reptile, or Cyborg.`
    },
    {
        title: 'Character Customization',
        description: `You can customize your character by choosing the color of their skin,
          the color of their eyes, and the color of their clothes.`
    }
];